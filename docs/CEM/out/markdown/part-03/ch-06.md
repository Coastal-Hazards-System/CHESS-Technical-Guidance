...
- III-6-2. Combined Wave and Current Bottom Boundary Layer Flow
  ...
  - c. Wave boundary layer
    - (1) Introduction
    - (2) Evaluation of the wave friction factor
    - (3) Wave boundary layer thickness
    - (4) The velocity profile
    - (5) Extension to spectral waves
    - (6) Dissipation
  - d. Combined wave-current boundary layers
    - (1) Introduction
    - (2) Combined wave-current velocity profile
    - (3) Combined wave-current bottom shear stress
...
- III-6-3. Fluid-Sediment Interaction
  ...
  - d. Bottom roughness and ripple generation
...
- III-6-4. Bed-load Transport
  - a. Introduction
  - b. Pure waves on sloping bottom
  - c. Combined wave-current flows
  - d. Combined current and bottom slope effect
  - e. Extension to spectral waves
...
- III-6-5. Suspended Load Transport
  ...
  - c. Reference concentration for suspended sediments
    - (1) Introduction
    - (2) Mean reference concentration
    - (3) Wave reference concentration
  - d. Concentration distribution of suspended sediment
    - (1) Mean concentration distribution
    - (2) Wave-associated concentration distribution
  - e. Suspended load transport
    - (1) Mean suspended load transport
    - (2) Mean wave-associated suspended load transport
      - flows
  - f. Extensions of methodology for the computation of suspended load
    - (1) Extension to spectral waves
    - (2) Extension to sediment mixtures
...
- 7) If $z_{r}$ = 7 D < $z_{0}$ = $k_{n}/30,$ the mean wave-associated suspended sediment transport is obtained q ¯ sSw from Equations 6-96 through 6-98.
...
| τwm | Maximum bottom shear stress $[force/length^{2}]$ |
