...
- Figure III-6-10. Conceptualization of pressure drag τOb , skin friction τb N, total shear stress τb N+τOb , for turbulent flow over a rippled bed III-6-34
...
The wave friction factor fw , the maximum shear velocity u * wm , the maximum bottom shear stress τ wm , and the bottom shear stress phase angle φ, for a pure wave motion over a flat bed.
...
- 5) If knu * wm /ν $ 3.3, flow is rough turbulent. Results ( fw and u * cw ) obtained in steps 2 and 3 constitute the solution. τ wm is obtained from Equation 6-14 or 6-15 and φ is obtained by solving Equation 6-12 with z 0 = kn /30.
...
- 9) The phase angle φ is calculated from Equation 6-12 using z 0 from step 8.
(Sheet 1 of 3)
...
- (2) Combined wave-current velocity profile. Having chosen the x -axis as the direction of wave propagation, the wave orbital velocity profile immediately above the bottom is given by Equation 6-11 where the phase angle φ defined by Equation 6-12 is evaluated with u * wm = u * m .
...
- 5) The sediment suspension phase angle φs is obtained from Equation 6-83 with zr = 7 D .
