...
*Case b. From Equation VI-6-45 for Hs = 13.0 ft and other wave periods, $T_{p}$ with no partial safety factors.*
...
- 2. Breaking waves, $K_{D}$ = 2, $H_{b}$ = 2.34 m (7.7 ft) W 50 = 14,830 N (3,334 lb) Dn 50 = 0.83 m (2.7 ft)
(Sheet 1 of 6)
...
- (4) Wave period, $T_{p}$ = 14 s (investigate W for Tp = 11 s, 9 s)
