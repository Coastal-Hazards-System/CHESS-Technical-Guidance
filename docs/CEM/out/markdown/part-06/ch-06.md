...
- Figure VI-6-4. Illustration of β in normalized coordinate system VI-6-8
- Figure VI-6-5. Definition of the Hasofer and Lind reliability index, βHL VI-6-9
...
- Table VI-6-1. Typical Variational Coefficients σΝ = σ /μ (standard deviation over mean value) for Measured and Calculated Sea State Parameters VI-6-24
