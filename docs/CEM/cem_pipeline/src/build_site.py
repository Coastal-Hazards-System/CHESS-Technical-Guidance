...
# ============================== templates ==================================
_CSS = r"""
/* CHESS-TG site — WaveMaker theming, mirrors CHESS-QC (Original palette, Trail
   vibe: amber diagonal texture), light/dark. */
:root, html[data-theme="light"]{
  --bg:#f6f3ed; --fg:#16211f; --panel:#fff; --border:#e2dcd0; --header-bg:#eeeae1;
  --label:#4c5a5c; --muted:#7c888b; --grid:#e2dcd0; --ctl-bg:#fff; --ctl-border:#cfc7b7;
  --btn-bg:#fbf8f2; --btn-hover:#f1ede4;
  --accent:#0a82a2; --accent-hover:#00799f; --on-accent:#fff; --danger:#bc2614;
  --cls-a:#587836; --cls-b:#a98c5b; --cls-c:#bc2614;
  --area-1:#0a82a2; --area-2:#587836; --area-3:#cbb07e; --area-4:#7c5c3e;
  --area-5:#bc2614; --area-6:#0e9cbe; --area-7:#a98c5b; --area-8:#415a28;
  --area-9:#6a4ca8; --area-10:#b83280; --area-11:#5a6673;
  /* Trail vibe (shape / typography) + texture, applied across both modes */
  --radius:6px; --ctl-radius:4px; --bw:1px; --weight:700; --shadow:0 1px 3px rgba(0,0,0,.08);
  --font:"Segoe UI Variable Text","Segoe UI",system-ui,sans-serif;
  --mono:"Cascadia Mono",Consolas,monospace;
  --texture:repeating-linear-gradient(135deg, rgba(245,174,27,.05) 0 2px, transparent 2px 9px);
}
html[data-theme="dark"]{
  --bg:#0b1316; --fg:#eaf2f3; --panel:#121d21; --border:#243035; --header-bg:#0a1115;
  --label:#a7b7bb; --muted:#6e8086; --grid:#243035; --ctl-bg:#16242a; --ctl-border:#33444b;
  --btn-bg:#16242a; --btn-hover:#1b2a30;
  --accent:#2bb8d4; --accent-hover:#5bcee2; --on-accent:#06222a; --danger:#e5654f;
  --cls-a:#9cb57a; --cls-b:#dcc8a1; --cls-c:#e5654f;
  --area-1:#2bb8d4; --area-2:#9cb57a; --area-3:#dcc8a1; --area-4:#9a7b5c;
  --area-5:#e5654f; --area-6:#5bcee2; --area-7:#cbb07e; --area-8:#74974f;
  --area-9:#9a86d4; --area-10:#d97bb5; --area-11:#93a0ad;
}
...
_THEME_JS = """
    (function(){
      ...
      function sync(){var d=document.documentElement.getAttribute("data-theme")==="dark";
        ...
        var l=document.getElementById("modeLbl"); if(l)l.textContent=d?"Dark mode":"Light mode";}
