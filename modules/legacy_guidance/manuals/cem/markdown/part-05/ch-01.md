...
- V-1-1. Background
  ...
  - g. Construction and monitoring
    - (1) Construction
    - (2) Post-construction inspection and monitoring
...
- V-1-3. Risk Analysis and Project Optimization
  ...
  - c. Reasons for risk-based analysis
    - (1) Introduction
      - (a) Coastal forcing is probabilistic
      - (b) Coastal engineering embodies major uncertainties
      - (c) Damage and functional performance change incrementally
      - (d) Benefits and risks not fully represented in deterministic terms
      - (e) Uncertain effects on adjacent areas
    - (2) Professional judgement
  - d. Considerations for including risk-based analysis in project design
    - (1) Objectives
    - (2) Key variables
    - (3) Professional judgement
    - (4) Resistance and functional performance vary with time
    - (5) Construction season and mobilization concerns
    - (6) Environmental, aesthetic, social, and political concerns
  - e. Frequency-based vs. life cycle approach
  - f. Typical project elements
    - (1) Site characterization
    - (2) Without-plan alternative
    - (3) Formulate, evaluate, and compare alternative plans
- V-1-4. References
...
Section 404 of the Clean Water Act mandates a Federal permit for discharges of dredged or fill material in waters of the United States, which include tributaries and wetlands adjacent to navigable waters, and extends to headwaters of streams with flows greater that 0.142 $m^{3}/sec$ (5 $ft^{3}/sec$). Wetlands are defined as "those areas inundated or saturated by surface or groundwater at a frequency and duration sufficient to support, and that under normal conditions do support, a prevalence of
